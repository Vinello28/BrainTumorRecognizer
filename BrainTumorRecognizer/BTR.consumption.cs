...
namespace BrainTumorRecognizer
{
    public partial class BTR
    {
        /// <summary>
        /// model input class for BTR.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.GetFullPath("BTR.mlnet");
